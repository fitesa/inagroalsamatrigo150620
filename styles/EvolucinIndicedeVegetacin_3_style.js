...
var style_EvolucinIndicedeVegetacin_3 = function(feature, resolution){
    ...
    if (value >= -0.509378 && value <= -0.395959) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.395959 && value <= -0.282540) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.282540 && value <= -0.169121) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.169121 && value <= -0.055702) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.055702 && value <= 0.057717) {
            style = [ new ol.style.Style({
