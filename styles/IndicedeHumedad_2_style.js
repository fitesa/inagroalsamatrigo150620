...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.160361 && value <= -0.123925) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.123925 && value <= -0.087490) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.087490 && value <= -0.051054) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.051054 && value <= -0.014619) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.014619 && value <= 0.021817) {
            style = [ new ol.style.Style({
